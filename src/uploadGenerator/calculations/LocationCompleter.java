...
//        m49_list2 = new String[m49_list.length][m49_list[0].length];
//
//        for(int i = 0; i < m49_list.length; i++){
//            String[] iso3s = m49_list[i][0].split(",");
//            String c = "";
//            for(String s : iso3s){
//                c += iso3CountryCodeToIso2CountryCode(s);
//            }
//            m49_list2[i] = new String[]{c, m49_list[i][1], m49_list[i][2], m49_list[i][3]};
//        }
//    }
    ...
    public String[] getCompletedInformation() {
        ...
        fillMissingGeoSample(sample_lat, sample_long, sample_region,sample_subregion, sample_inter_region, sample_country);
        ...
        fillMissingGeoSampling(sampling_lat, sampling_long, sampling_region,sampling_subregion, sampling_inter_region, sampling_country);
        ...
        fillMissingGeoTma(sample_tma_lat, sample_tma_long, sample_tma_region,sample_tma_subregion, sample_tma_inter_region, sample_tma_country);
    ...
    private void fillMissingGeoSample(String lat, String lon, String region, String subregion, String inter_region, String coun){



        if(lat.equals("") && lon.equals("") && region.equals("") && subregion.equals("") &&
                inter_region.equals("") && coun.equals("")){
            ////System.out.println("No sample geo info.");

        } else if(!lat.equals("") && !lon.equals("") && !region.equals("") && !subregion.equals("") &&
                !inter_region.equals("") && !coun.equals("")){
            ////System.out.println("All sample geo info given.");
        ...
        } else if(lat.equals("") && lon.equals("") && !coun.equals("")){
            ////System.out.println("Country given.");
            fillBasedOnCountry(coun, index_sample_origin_region, index_sample_origin_subregion, index_sample_origin_intermediate_region);

        } else if(lat.equals("") && lon.equals("") && !inter_region.equals("")){
        ...
        } else if(lat.equals("") && lon.equals("") && !subregion.equals("")){
    ...
    private void fillMissingGeoSampling(String lat, String lon, String region, String subregion, String inter_region, String coun){
        ...
        if(lat.equals("") && lon.equals("") && region.equals("") && subregion.equals("") &&
            ...
            //System.out.println("Country given.");
            fillBasedOnCountry(coun, index_sampling_region, index_sampling_subregion, index_sampling_intermediate_region);
    ...
    private void fillMissingGeoTma(String lat, String lon, String region, String subregion, String inter_region, String coun){
        ...
        if(lat.equals("") && lon.equals("") && region.equals("") && subregion.equals("") &&
            ...
            //System.out.println("Country given.");
            fillBasedOnCountry(coun, index_TMA_inferrred_region, index_TMA_inferrred_subregion, index_TMA_inferrred_intermediate_region);
    ...
    private void fillBasedOnLatLong(double lat, double lon, int index_country, int index_region,
        ...
        geocoder.getCountry(lat, lon).ifPresent(country -> {
            ...
            if( country.iso3()==null){
                ...
                entry[index_country] = country.iso3();
            }
    ...
    private void fillBasedOnCountry(String country, int index_region, int index_subregion, int index_intermediate_region){
